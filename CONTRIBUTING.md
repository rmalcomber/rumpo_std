...
> [Documentation](https://github.com/rmalcomber/rumpo_std/blob/main/README.md).

Before you ask a question, it is best to search for existing
[Issues](https://github.com/rmalcomber/rumpo_std/issues) that might help you. In
...
- Open an [Issue](https://github.com/rmalcomber/rumpo_std/issues/new).
...
- To see if other users have experienced (and potentially already solved) the
  ...
  [bug tracker](https://github.com/rmalcomber/rumpo_std/issues?q=label%3Abug).
...
> Instead sensitive bugs must be sent by email to <security@malcomber.com>.
...
- Open an [Issue](https://github.com/rmalcomber/rumpo_std/issues/new). (Since we
...
@rumpo/std, **including completely new features and minor improvements to
...
- Perform a [search](https://github.com/rmalcomber/rumpo_std/issues) to see if
...
[GitHub issues](https://github.com/rmalcomber/rumpo_std/issues).
...
- **Explain why this enhancement would be useful** to most @rumpo/std users. You
